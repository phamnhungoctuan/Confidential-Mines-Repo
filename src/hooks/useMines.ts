...
/** ⚡ Cấu hình Sepolia cho fhevm SDK */
const sdkConfig = {
...
/** ⚡ Lấy instance contract với signer MetaMask */
...
/** ⚡ Encrypt toàn bộ board bằng worker */
...
export async function createGame(board: number[], seed: number) {
  ...
  // ✅ Commit hash = hash(seed, player, boardSize)
...
/** 📜 Reveal plaintext board (optional) */
